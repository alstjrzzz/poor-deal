...
<head>
    ...
    <style>
        ...
        .charge-container { max-width: 480px; margin: 60px auto; }
        .charge-card { border: none; border-radius: 15px; box-shadow: 0 10px 25px rgba(0,0,0,0.05); background: white; overflow: hidden; }
        .charge-header { background-color: #fff; padding: 2rem 2rem 1rem 2rem; text-align: center; }
        .btn-amount { border: 1px solid #dee2e6; background-color: #fff; color: #495057; padding: 12px; border-radius: 10px; font-weight: 500; transition: all 0.2s; }
        .btn-amount:hover { background-color: #f8f9fa; transform: translateY(-2px); box-shadow: 0 2px 5px rgba(0,0,0,0.05); }
        .btn-amount.active { border-color: #0d6efd; background-color: #e7f1ff; color: #0d6efd; font-weight: bold; }
        .form-control:focus { box-shadow: none; border-color: #0d6efd; }
        .input-group-text { background-color: #f8f9fa; border-right: none; }
        .form-control { border-left: none; text-align: right; font-weight: bold; font-size: 1.2rem; }
            ...
            <form action="/trade/charge" method="post" id="chargeForm">
                ...
                <div class="mb-4">
                    ...
                    <div class="input-group input-group-lg border rounded-3 overflow-hidden">
                        ...
                        <%-- [수정 완료] step="1000" 제거됨. 이제 어떤 숫자든 입력 가능합니다. --%>
